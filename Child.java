...
public class Child extends User {
	...
	public void ListAllWishesD() {
	    ...
	    System.out.println("----- Wishes for today (" + today.format(dateFormatter) + ") -----");
	        ...
	        try {
	            ...
	            if (isToday) {
	                System.out.println(
	                    ...
	                    " | Start: " + (wish.getStartDate() != null ? wish.getStartDate() + " " + wish.getStartTime() : "Not identified") +
	                    " | End: " + (wish.getEndDate() != null ? wish.getEndDate() + " " + wish.getEndTime() : "Not identified")
	                );
	            ...
	            System.err.println("Date/time format is invalid (ID: " + wish.getWishId() + "): " + e.getMessage());
	        }
	    }

	    if (!foundAny) {
	        System.out.println("There is no wishes for today");
	    }
	...
	public void ListAllWishesW() {
	    ...
	    System.out.println("----- Wishes for this week (" +
	    ...
	    for (Wishes wish : ReadFile.Wishes.values()) {
	        try {
	            ...
	            if (wish.getStartDate() != null && !wish.getStartDate().isEmpty()) {
	                ...
	                if (!startDate.isBefore(today) && !startDate.isAfter(nextWeek)) {
	                    System.out.println(
	                        ...
	                        " | Hour: " + (wish.getStartTime() != null ? wish.getStartTime() : "Not identified") +
	                        " | Type: Start"
	                    );
	            ...
	            if (!printed && wish.getEndDate() != null && !wish.getEndDate().isEmpty()) {
	                ...
	                if (!endDate.isBefore(today) && !endDate.isAfter(nextWeek)) {
	                    System.out.println(
	                        "ID: " + wish.getWishId() +
	                        " | Title: " + wish.getWishTitle() +
	                        " | Date: " + endDate.format(displayFormatter) +
	                        " | Hour: " + (wish.getEndTime() != null ? wish.getEndTime() : "Not identified") +
	                        " | Type: End"
	                    );
	                    foundAny = true;
	            ...
	            System.err.println("Date/hour format is invalid (ID: " + wish.getWishId() + "): " + e.getMessage());
	        }
	    }

	    if (!foundAny) {
	        System.out.println("There is no wishes for this week.");
	    }
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    System.err.println("Missing spot: " + line);
                }
            }
        } catch (IOException e) {
            System.err.println("Wishes.txt cannot read: " + e.getMessage());
        }
